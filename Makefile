...
piclock:	piclock.cpp blocking_tcp_client.cpp openvg/libshapes.o openvg/oglinit.o ntpstat.o libmcp23s17/libmcp23s17.a libpifacedigital/libpifacedigital.a
	gcc -O4 -Wall -I/opt/vc/include -Ilibmcp23s17/src -Ilibpifacedigital/src -I/opt/vc/include/interface/vcos/pthreads -Iopenvg -o piclock piclock.cpp ntpstat.o openvg/libshapes.o openvg/oglinit.o -L/opt/vc/lib -Llibmcp23s17 -Llibpifacedigital -lGLESv2 -lEGL -lbcm_host -ljpeg -lpthread -lm -lpifacedigital -lmcp23s17 -lpthread -lstdc++ -lboost_system -lboost_program_options -lssl -lcrypto -std=c++11
